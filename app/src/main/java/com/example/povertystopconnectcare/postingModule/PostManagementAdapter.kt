...
class PostManagementAdapter(private val context: Context,
                            private var postList: ArrayList<Post>,
                            private val dbHelper: DatabaseHelper)
    : RecyclerView.Adapter<PostManagementAdapter.PostViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = PostViewHolder (
        LayoutInflater.from(parent.context).inflate(R.layout.activity_post_details, parent, false)
    )
    ...
    class PostViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        private var image = view.findViewById<ImageView>(R.id.postImageM)
        private var title = view.findViewById<TextView>(R.id.postTitleM)
        private var description = view.findViewById<TextView>(R.id.postDescriptionM)
        private var btnEdit: ImageView = view.findViewById(R.id.editPost)
        private var btnDelete: ImageView = view.findViewById(R.id.deletePost)
        ...
        fun bindView(post: Post, context: Context) {
            ...
            btnEdit.setOnClickListener {
                val i = Intent(context,PostUpdateActivity::class.java )
                i.putExtra("Mode","E")
